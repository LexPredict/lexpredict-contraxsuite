...
from apps.users.social.okta.adapters import OktaOAuth2Adapter
...
class OktaLoginView(SocialLoginView):
    ...
    1. Redirect to okta auth page `https://{{your domain}}.okta.com/oauth2/default/v1/authorize`
    ...
    callback_url = settings.SOCIAL_OKTA_CALLBACK_URL
