...
from apps.users.social.elevate.clients import ElevateOAuth2Client
from apps.users.social.serializers import CustomSocialLoginSerializer
from apps.users.social.elevate.adapters import ElevateOAuth2Adapter
...
class ElevateLoginView(SocialLoginView):
    ...
    """
    adapter_class = ElevateOAuth2Adapter
    callback_url = settings.SOCIAL_ELEVATE_CALLBACK_URL
    client_class = ElevateOAuth2Client
