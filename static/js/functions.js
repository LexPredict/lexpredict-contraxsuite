...
(function() {
	...
	var content = $('#content');
	var activeAccordion = sidebar.find('a[href="' + '/' + document.location.pathname.substring(1) + '"]');

	if (activeAccordion) {
		activeAccordion.addClass('active');

		if (activeAccordion.parent() && activeAccordion.parent().parent()) {
			activeAccordion.parent().parent().addClass('show');
			activeAccordion.parent().parent().prev().addClass('active');
		}
	}
