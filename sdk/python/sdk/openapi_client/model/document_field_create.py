...
class DocumentFieldCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'category': (int, none_type,),  # noqa: E501
            'family': (int, none_type,),  # noqa: E501
            'default_value': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            'choices': (str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_type, code, title, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category (int, none_type): [optional]  # noqa: E501
            family (int, none_type): [optional]  # noqa: E501
            ...
            choices (str, none_type): Newline-separated choices. A choice cannot contain a comma.. [optional]  # noqa: E501
            ...
            hide_until_js (str, none_type): Target expression (\"Hide until python\" expression converted to JavaScript syntax for frontend). Allowed operators: +, -, *, /, ===, !==, ==, !=, &&, ||, >, <, >=, <=, %. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_type, code, title, type, *args, **kwargs):  # noqa: E501
        """DocumentFieldCreate - a model defined in OpenAPI
