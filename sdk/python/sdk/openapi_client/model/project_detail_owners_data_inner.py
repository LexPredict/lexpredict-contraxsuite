...
class ProjectDetailOwnersDataInner(ModelNormal):
    ...
    def _from_openapi_data(cls, username, email, *args, **kwargs):  # noqa: E501
        """ProjectDetailOwnersDataInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            permissions ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
            groups ([int]): The groups this user belongs to. A user will get all permissions granted to each of their groups.. [optional]  # noqa: E501
        """
