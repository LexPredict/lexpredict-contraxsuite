...
class DocumentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.document_documents_id_set_annotator_coord_difference_post_endpoint = _Endpoint(
            settings={
                'response_type': (DocumentSetAnnotatorCoordinatesDifferenceResponse,),
                'auth': [
                    'AuthToken'
                ],
                'endpoint_path': '/api/v1/document/documents/{id}/set_annotator_coord_difference/',
                'operation_id': 'document_documents_id_set_annotator_coord_difference_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'id',
                    'document_set_annotator_coordinates_difference_request',
                ],
                'required': [
                    'id',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'document_set_annotator_coordinates_difference_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.document_project_project_pk_documents_id_set_annotator_coord_difference_post_endpoint = _Endpoint(
            settings={
                'response_type': (DocumentSetAnnotatorCoordinatesDifferenceResponse,),
                'auth': [
                    'AuthToken'
                ],
                'endpoint_path': '/api/v1/document/project/{project_pk}/documents/{id}/set_annotator_coord_difference/',
                'operation_id': 'document_project_project_pk_documents_id_set_annotator_coord_difference_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def document_documents_id_set_annotator_coord_difference_post(
        self,
        id,
        **kwargs
    ):
        """document_documents_id_set_annotator_coord_difference_post  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.document_documents_id_set_annotator_coord_difference_post(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            document_set_annotator_coordinates_difference_request (DocumentSetAnnotatorCoordinatesDifferenceRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.document_documents_id_set_annotator_coord_difference_post_endpoint.call_with_http_info(**kwargs)
    ...
    def document_project_project_pk_documents_id_set_annotator_coord_difference_post(
        self,
        project_pk,
        id,
        **kwargs
    ):
        """document_project_project_pk_documents_id_set_annotator_coord_difference_post  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.document_project_project_pk_documents_id_set_annotator_coord_difference_post(project_pk, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.document_project_project_pk_documents_id_set_annotator_coord_difference_post_endpoint.call_with_http_info(**kwargs)
