...
class CommonApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.common_logo_get_endpoint = _Endpoint(
            settings={
                'response_type': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),
                'auth': [
                    'AuthToken'
                ],
                'endpoint_path': '/api/v1/common/logo/',
                'operation_id': 'common_logo_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def common_logo_get(
        ...
        **kwargs
        ...
        """common_logo_get  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_logo_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.common_logo_get_endpoint.call_with_http_info(**kwargs)
