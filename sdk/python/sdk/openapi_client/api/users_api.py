...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __users_social_accounts_get(
            self,
            **kwargs
        ):
        ...
        self.users_social_accounts_get = _Endpoint(
            settings={
            ...
            callable=__users_social_accounts_get
        )

        def __users_users_form_fields_get(
            self,
            **kwargs
        ):
        ...
        self.users_users_form_fields_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__users_users_form_fields_get
        )

        def __users_users_get(
            self,
            **kwargs
        ):
        ...
        self.users_users_get = _Endpoint(
            settings={
                'response_type': ([User],),
                'auth': [
                    'AuthToken'
            ...
            api_client=api_client,
            callable=__users_users_get
        )

        def __users_users_id_form_fields_get(
            self,
            id,
            **kwargs
        ):
        ...
        self.users_users_id_form_fields_get = _Endpoint(
            settings={
                'response_type': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),
                'auth': [
                    'AuthToken'
            ...
            api_client=api_client,
            callable=__users_users_id_form_fields_get
        )

        def __users_users_id_get(
            self,
            id,
            **kwargs
        ):
        ...
        self.users_users_id_get = _Endpoint(
            settings={
                'response_type': (User,),
                'auth': [
                    'AuthToken'
            ...
            api_client=api_client,
            callable=__users_users_id_get
        )

        def __users_users_id_patch(
            self,
            id,
            **kwargs
        ):
        ...
        self.users_users_id_patch = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__users_users_id_patch
        )

        def __users_users_id_put(
            self,
            id,
            **kwargs
        ):
        ...
        self.users_users_id_put = _Endpoint(
            settings={
                'response_type': (UserProfile,),
                'auth': [
                    'AuthToken'
            ...
            api_client=api_client,
            callable=__users_users_id_put
        )

        def __users_users_post(
            self,
            **kwargs
        ):
        ...
        self.users_users_post = _Endpoint(
            settings={
                'response_type': (UserProfile,),
                'auth': [
                    'AuthToken'
            ...
            api_client=api_client,
            callable=__users_users_post
        )

        def __users_users_user_stats_get(
            self,
            **kwargs
        ):
        ...
        self.users_users_user_stats_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__users_users_user_stats_get
        )

        def __users_verify_token_post(
            self,
            **kwargs
        ):
        ...
        self.users_verify_token_post = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__users_verify_token_post
        )
