...
public class CommonApi {
     ...
     */
    public List<List<Action>> commonActionsGET(Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters) throws ApiException {
        ApiResponse<List<List<Action>>> localVarResp = commonActionsGETWithHttpInfo(projectId, documentId, viewActions, jqFilters);
     ...
     * @param viewActions Action names (optional)
     * @param jqFilters Filter params similar to JQWidgets grid filter params:                             filterscount&#x3D;1,                             filterdatafield0&#x3D;\&quot;a\&quot;,                             filtervalue0&#x3D;\&quot;b\&quot;,                             filtercondition0&#x3D;\&quot;CONTAINS\&quot;,                             filteroperator0&#x3D;1,                             sortdatafied&#x3D;\&quot;c\&quot;,                            sortorder&#x3D;\&quot;asc\&quot;                             (optional)
     * @return ApiResponse&lt;List&lt;List&lt;Action&gt;&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<List<Action>>> commonActionsGETWithHttpInfo(Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters) throws ApiException {
        okhttp3.Call localVarCall = commonActionsGETValidateBeforeCall(projectId, documentId, viewActions, jqFilters, null);
        Type localVarReturnType = new TypeToken<List<List<Action>>>(){}.getType();
     ...
     */
    public okhttp3.Call commonActionsGETAsync(Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters, final ApiCallback<List<List<Action>>> _callback) throws ApiException {
     ...
     */
    public List<Action> commonActionsIdGET(String id, Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters) throws ApiException {
        ApiResponse<List<Action>> localVarResp = commonActionsIdGETWithHttpInfo(id, projectId, documentId, viewActions, jqFilters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Action>> commonActionsIdGETWithHttpInfo(String id, Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters) throws ApiException {
     ...
     */
    public okhttp3.Call commonActionsIdGETAsync(String id, Integer projectId, Integer documentId, List<String> viewActions, Map<String, String> jqFilters, final ApiCallback<List<Action>> _callback) throws ApiException {
