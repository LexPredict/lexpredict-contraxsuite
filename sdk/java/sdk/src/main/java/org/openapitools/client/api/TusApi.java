...
import java.io.File;
import org.openapitools.client.model.TusUploadSessionUploadSessionIdUploadPOST400Response;
...
public class TusApi {
     ...
     * @param force Upload a file even if it exists. (optional)
     * @param body  (optional)
     * @return TusUploadSessionUploadSessionIdUploadPOST400Response
     ...
     */
    public TusUploadSessionUploadSessionIdUploadPOST400Response tusUploadSessionUploadSessionIdUploadGuidPATCH(String uploadSessionId, String guid, Integer uploadOffset, String tusResumable, Boolean force, File body) throws ApiException {
        ApiResponse<TusUploadSessionUploadSessionIdUploadPOST400Response> localVarResp = tusUploadSessionUploadSessionIdUploadGuidPATCHWithHttpInfo(uploadSessionId, guid, uploadOffset, tusResumable, force, body);
     ...
     * @param force Upload a file even if it exists. (optional)
     * @param body  (optional)
     * @return ApiResponse&lt;TusUploadSessionUploadSessionIdUploadPOST400Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TusUploadSessionUploadSessionIdUploadPOST400Response> tusUploadSessionUploadSessionIdUploadGuidPATCHWithHttpInfo(String uploadSessionId, String guid, Integer uploadOffset, String tusResumable, Boolean force, File body) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<TusUploadSessionUploadSessionIdUploadPOST400Response>(){}.getType();
     ...
     */
    public okhttp3.Call tusUploadSessionUploadSessionIdUploadGuidPATCHAsync(String uploadSessionId, String guid, Integer uploadOffset, String tusResumable, Boolean force, File body, final ApiCallback<TusUploadSessionUploadSessionIdUploadPOST400Response> _callback) throws ApiException {
