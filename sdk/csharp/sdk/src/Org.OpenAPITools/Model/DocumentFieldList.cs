...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentFieldList :  IEquatable<DocumentFieldList>, IValidatableObject
    {
        ...
        public DocumentFieldList(string documentType = default(string), string code = default(string), string longCode = default(string), string title = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), TextUnitTypeEnum? textUnitType = default(TextUnitTypeEnum?), ValueDetectionStrategyEnum? valueDetectionStrategy = default(ValueDetectionStrategyEnum?), PythonCodedFieldEnum? pythonCodedField = default(PythonCodedFieldEnum?), string classifierInitScript = default(string), string formula = default(string), bool convertDecimalsToFloatsInFormulaArgs = default(bool), string valueRegexp = default(string), ConfidenceEnum? confidence = default(ConfidenceEnum?), bool requiresTextAnnotations = default(bool), bool readOnly = default(bool), DocumentFieldListCategory category = default(DocumentFieldListCategory), DocumentFieldListFamily family = default(DocumentFieldListFamily), Object defaultValue = default(Object), bool allowValuesNotSpecifiedInChoices = default(bool), Object stopWords = default(Object), Object metadata = default(Object), bool trainingFinished = default(bool), bool dirty = default(bool), int order = default(int), int trainedAfterDocumentsNumber = default(int), bool hiddenAlways = default(bool), string hideUntilPython = default(string), string hideUntilJs = default(string), DetectLimitUnitEnum? detectLimitUnit = default(DetectLimitUnitEnum?), int detectLimitCount = default(int), bool displayYesNo = default(bool), int? createdBy = default(int?), int? modifiedBy = default(int?), string vectorizerStopWords = default(string), string unsureChoiceValue = default(string), Object unsureThresholdsByValue = default(Object), string mlflowModelUri = default(string), bool mlflowDetectOnDocumentLevel = default(bool))
        {
            ...
            if (modifiedBy == null)
            {
                throw new InvalidDataException("modifiedBy is a required property for DocumentFieldList and cannot be null");
            }
            else
            {
