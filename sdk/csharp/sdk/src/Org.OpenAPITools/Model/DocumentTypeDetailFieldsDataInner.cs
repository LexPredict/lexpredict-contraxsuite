...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentTypeDetailFieldsDataInner :  IEquatable<DocumentTypeDetailFieldsDataInner>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTypeDetailFieldsDataInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentTypeDetailFieldsDataInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTypeDetailFieldsDataInner" /> class.
        /// </summary>
        ...
        public DocumentTypeDetailFieldsDataInner(string documentType = default(string), string code = default(string), string longCode = default(string), string title = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), TextUnitTypeEnum? textUnitType = default(TextUnitTypeEnum?), ValueDetectionStrategyEnum? valueDetectionStrategy = default(ValueDetectionStrategyEnum?), string classifierInitScript = default(string), string formula = default(string), bool convertDecimalsToFloatsInFormulaArgs = default(bool), string valueRegexp = default(string), ConfidenceEnum? confidence = default(ConfidenceEnum?), bool requiresTextAnnotations = default(bool), bool readOnly = default(bool), DocumentFieldListCategory category = default(DocumentFieldListCategory), int? family = default(int?), Object defaultValue = default(Object), bool allowValuesNotSpecifiedInChoices = default(bool), Object metadata = default(Object), bool trainingFinished = default(bool), bool dirty = default(bool), int order = default(int), int trainedAfterDocumentsNumber = default(int), bool hiddenAlways = default(bool), string hideUntilPython = default(string), string hideUntilJs = default(string), bool displayYesNo = default(bool), string vectorizerStopWords = default(string), string unsureChoiceValue = default(string), Object unsureThresholdsByValue = default(Object), string mlflowModelUri = default(string), bool mlflowDetectOnDocumentLevel = default(bool))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for DocumentTypeDetailFieldsDataInner and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for DocumentTypeDetailFieldsDataInner and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        /// </summary>
        [DataMember(Name="document_type__title", EmitDefaultValue=false)]
        public string DocumentTypeTitle { get; private set; }
        ...
        {
            return this.Equals(input as DocumentTypeDetailFieldsDataInner);
        }

        /// <summary>
        /// Returns true if DocumentTypeDetailFieldsDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentTypeDetailFieldsDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentTypeDetailFieldsDataInner input)
        {
            if (input == null)
                return false;
