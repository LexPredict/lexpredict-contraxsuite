...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimilarityRun :  IEquatable<SimilarityRun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimilarityRun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimilarityRun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimilarityRun" /> class.
        /// </summary>
        ...
        public SimilarityRun(string featureSource = default(string), string unitSource = default(string), string unitType = default(string), int? unitId = default(int?), int itemsCount = default(int), int? createdBy = default(int?), DateTime createdDate = default(DateTime))
        {
            ...
            if (itemsCount == null)
            {
                throw new InvalidDataException("itemsCount is a required property for SimilarityRun and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SimilarityRun);
        }

        /// <summary>
        /// Returns true if SimilarityRun instances are equal
        /// </summary>
        /// <param name="input">Instance of SimilarityRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimilarityRun input)
        {
            if (input == null)
                return false;
