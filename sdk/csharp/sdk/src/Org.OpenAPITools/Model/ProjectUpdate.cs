...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectUpdate :  IEquatable<ProjectUpdate>, IValidatableObject
    {
        ...
        public ProjectUpdate(string name = default(string), string description = default(string), int status = default(int), bool sendEmailNotification = default(bool), List<int> owners = default(List<int>), List<int> reviewers = default(List<int>), List<int> superReviewers = default(List<int>), List<int> juniorReviewers = default(List<int>), string type = default(string), bool hideClauseReview = default(bool))
        {
