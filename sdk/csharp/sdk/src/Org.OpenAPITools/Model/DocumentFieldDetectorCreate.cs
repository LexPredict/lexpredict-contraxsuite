...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentFieldDetectorCreate :  IEquatable<DocumentFieldDetectorCreate>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Defines which part of the matched Text Unit  should be passed to the extraction function. Example: In the string \&quot;2019-01-23 is the start date and 2019-01-24 is the  end date,\&quot; if text part &#x3D; \&quot;Before matching substring\&quot; and Include regexp is \&quot;is.{0,100}start\&quot; then \&quot;2019-01-23\&quot; will be  parsed correctly as the start date.</value>
        [DataMember(Name="text_part", EmitDefaultValue=true)]
        ...
        /// <param name="textPart">Defines which part of the matched Text Unit  should be passed to the extraction function. Example: In the string \&quot;2019-01-23 is the start date and 2019-01-24 is the  end date,\&quot; if text part &#x3D; \&quot;Before matching substring\&quot; and Include regexp is \&quot;is.{0,100}start\&quot; then \&quot;2019-01-23\&quot; will be  parsed correctly as the start date. (required).</param>
        ...
        public DocumentFieldDetectorCreate(CategoryEnum? category = default(CategoryEnum?), string excludeRegexps = default(string), string definitionWords = default(string), string includeRegexps = default(string), bool regexpsPreProcessLower = default(bool), string detectedValue = default(string), ExtractionHintEnum? extractionHint = default(ExtractionHintEnum?), TextPartEnum textPart = default(TextPartEnum), DetectLimitUnitEnum detectLimitUnit = default(DetectLimitUnitEnum), int detectLimitCount = default(int), string field = default(string))
        {
            ...
            // to ensure "textPart" is required (not null)
            if (textPart == null)
            {
                throw new InvalidDataException("textPart is a required property for DocumentFieldDetectorCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("detectLimitUnit is a required property for DocumentFieldDetectorCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("detectLimitCount is a required property for DocumentFieldDetectorCreate and cannot be null");
            }
            else
            {
