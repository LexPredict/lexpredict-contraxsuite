...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UserProfile :  IEquatable<UserProfile>, IValidatableObject
    {
        ...
        public UserProfile(string lastName = default(string), string firstName = default(string), string name = default(string), System.IO.Stream photo = default(System.IO.Stream), string organization = default(string))
        {
            this.Photo = photo;
