...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentDetail :  IEquatable<DocumentDetail>, IValidatableObject
    {
        ...
        public DocumentDetail(string name = default(string), string documentType = default(string), int fileSize = default(int), string folder = default(string), DateTime? createdDate = default(DateTime?), string createdByName = default(string), DateTime? modifiedDate = default(DateTime?), string modifiedByName = default(string), int? status = default(int?), DocumentDetailStatusData statusData = default(DocumentDetailStatusData), int? assignee = default(int?), DateTime? assignDate = default(DateTime?), DocumentDetailAssigneeData assigneeData = default(DocumentDetailAssigneeData), List<DocumentDetailAvailableAssigneesData> availableAssigneesData = default(List<DocumentDetailAvailableAssigneesData>), string description = default(string), string title = default(string), List<DocumentDetailNotes> notes = default(List<DocumentDetailNotes>))
        {
            this.Name = name;
