...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentDetail :  IEquatable<DocumentDetail>, IValidatableObject
    {
        ...
        public List<DocumentDetailAvailableAssigneesDataInner> AvailableAssigneesData { get; set; }
        ...
        /// <summary>
        /// Gets or Sets WasOpenedInAnnotator
        /// </summary>
        [DataMember(Name="was_opened_in_annotator", EmitDefaultValue=false)]
        public bool WasOpenedInAnnotator { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WasOpenedInAnnotator: ").Append(WasOpenedInAnnotator).Append("\n");
        ...
        public bool Equals(DocumentDetail input)
        {
            ...
            return 
                ...
                (
                    this.WasOpenedInAnnotator == input.WasOpenedInAnnotator ||
                    (this.WasOpenedInAnnotator != null &&
                    this.WasOpenedInAnnotator.Equals(input.WasOpenedInAnnotator))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WasOpenedInAnnotator != null)
                    hashCode = hashCode * 59 + this.WasOpenedInAnnotator.GetHashCode();
