...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentTypeDetail :  IEquatable<DocumentTypeDetail>, IValidatableObject
    {
        ...
        public DocumentTypeDetail(string title = default(string), string code = default(string), List<string> searchFields = default(List<string>), EditorTypeEnum? editorType = default(EditorTypeEnum?), string createdByName = default(string), string modifiedByName = default(string), Object metadata = default(Object), int fieldsNumber = default(int), List<int> managers = default(List<int>))
        {
            ...
            {
                throw new InvalidDataException("createdByName is a required property for DocumentTypeDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modifiedByName is a required property for DocumentTypeDetail and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="created_by__name", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="modified_by__name", EmitDefaultValue=true)]
