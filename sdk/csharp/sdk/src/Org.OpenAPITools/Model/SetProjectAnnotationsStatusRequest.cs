...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SetProjectAnnotationsStatusRequest :  IEquatable<SetProjectAnnotationsStatusRequest>, IValidatableObject
    {
        ...
        public SetProjectAnnotationsStatusRequest(int? statusId = default(int?), bool all = default(bool), List<int> annotationIds = default(List<int>), List<int> noAnnotationIds = default(List<int>))
        {
