...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Action :  IEquatable<Action>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="user__initials", EmitDefaultValue=false)]
        public string UserInitials { get; private set; }

        /// <summary>
        /// Gets or Sets UserPhotoUrl
        /// </summary>
        [DataMember(Name="user_photo_url", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserPhotoUrl: ").Append(UserPhotoUrl).Append("\n");
        ...
        public bool Equals(Action input)
        {
            ...
            return 
                ...
                (
                    this.UserPhotoUrl == input.UserPhotoUrl ||
                    (this.UserPhotoUrl != null &&
                    this.UserPhotoUrl.Equals(input.UserPhotoUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserPhotoUrl != null)
                    hashCode = hashCode * 59 + this.UserPhotoUrl.GetHashCode();
