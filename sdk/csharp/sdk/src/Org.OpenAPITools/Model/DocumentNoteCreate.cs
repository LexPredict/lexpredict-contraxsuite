...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentNoteCreate :  IEquatable<DocumentNoteCreate>, IValidatableObject
    {
        ...
        public DocumentNoteCreate(string note = default(string), int? locationStart = default(int?), int? locationEnd = default(int?), int documentId = default(int), int fieldValueId = default(int), string fieldId = default(string), string username = default(string), DocumentDetailUser user = default(DocumentDetailUser))
        {
