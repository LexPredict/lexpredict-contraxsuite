...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentDetailAvailableAssigneesData :  IEquatable<DocumentDetailAvailableAssigneesData>, IValidatableObject
    {
        ...
        public DocumentDetailAvailableAssigneesData(string firstName = default(string), string lastName = default(string), string username = default(string), string name = default(string), string initials = default(string))
        {
