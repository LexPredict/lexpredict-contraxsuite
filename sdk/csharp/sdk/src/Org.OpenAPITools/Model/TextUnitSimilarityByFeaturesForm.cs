...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TextUnitSimilarityByFeaturesForm :  IEquatable<TextUnitSimilarityByFeaturesForm>, IValidatableObject
    {
        ...
        public TextUnitSimilarityByFeaturesForm(string runName = default(string), int? similarityThreshold = 75, int project = default(int), FeatureSourceEnum? featureSource = FeatureSourceEnum.Term, DistanceTypeEnum? distanceType = DistanceTypeEnum.Cosine, int itemId = default(int), bool createReverseRelations = default(bool), bool useTfidf = default(bool), bool delete = default(bool), UnitTypeEnum? unitType = UnitTypeEnum.Sentence)
        {
            ...
            if (runName == null)
            {
                throw new InvalidDataException("runName is a required property for TextUnitSimilarityByFeaturesForm and cannot be null");
            }
            else
            {
            ...
            if (itemId == null)
            {
                throw new InvalidDataException("itemId is a required property for TextUnitSimilarityByFeaturesForm and cannot be null");
            }
            else
            {
                this.ItemId = itemId;
            ...
            {
                throw new InvalidDataException("createReverseRelations is a required property for TextUnitSimilarityByFeaturesForm and cannot be null");
            }
            else
            {
            ...
            if (useTfidf == null)
            {
                throw new InvalidDataException("useTfidf is a required property for TextUnitSimilarityByFeaturesForm and cannot be null");
            }
            else
            {
            ...
            if (delete == null)
            {
                throw new InvalidDataException("delete is a required property for TextUnitSimilarityByFeaturesForm and cannot be null");
            }
            else
            {
                this.Delete = delete;
