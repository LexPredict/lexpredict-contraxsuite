...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentNoteDetailUser :  IEquatable<DocumentNoteDetailUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentNoteDetailUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentNoteDetailUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentNoteDetailUser" /> class.
        /// </summary>
        ...
        public DocumentNoteDetailUser(string firstName = default(string), string lastName = default(string), string username = default(string), string name = default(string), string initials = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for DocumentNoteDetailUser and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocumentNoteDetailUser);
        }

        /// <summary>
        /// Returns true if DocumentNoteDetailUser instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentNoteDetailUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentNoteDetailUser input)
        {
            if (input == null)
                return false;
