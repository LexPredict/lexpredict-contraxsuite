...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RatioUsage :  IEquatable<RatioUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatioUsage" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        /// <param name="amount2">amount2.</param>
        /// <param name="total">total.</param>
        /// <param name="count">count.</param>
        public RatioUsage(decimal? amount = default(decimal?), decimal? amount2 = default(decimal?), decimal? total = default(decimal?), int count = default(int))
        {
            this.Amount = amount;
        ...
        /// </summary>
        [DataMember(Name="amount2", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as RatioUsage);
        }

        /// <summary>
        /// Returns true if RatioUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of RatioUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatioUsage input)
        {
            if (input == null)
                return false;
