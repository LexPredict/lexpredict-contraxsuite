...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UploadSessionDetailProject :  IEquatable<UploadSessionDetailProject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadSessionDetailProject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UploadSessionDetailProject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadSessionDetailProject" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UploadSessionDetailProject);
        }

        /// <summary>
        /// Returns true if UploadSessionDetailProject instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadSessionDetailProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadSessionDetailProject input)
        {
            if (input == null)
                return false;
