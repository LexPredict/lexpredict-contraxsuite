...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldDetail :  IEquatable<DocumentFieldDetail>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentFieldDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldDetail" /> class.
        /// </summary>
        ...
        public DocumentFieldDetail(string documentType = default(string), string code = default(string), string longCode = default(string), string title = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), TextUnitTypeEnum? textUnitType = default(TextUnitTypeEnum?), ValueDetectionStrategyEnum? valueDetectionStrategy = default(ValueDetectionStrategyEnum?), PythonCodedFieldEnum? pythonCodedField = default(PythonCodedFieldEnum?), string classifierInitScript = default(string), string formula = default(string), bool convertDecimalsToFloatsInFormulaArgs = default(bool), string valueRegexp = default(string), ConfidenceEnum? confidence = default(ConfidenceEnum?), bool requiresTextAnnotations = default(bool), bool readOnly = default(bool), int? family = default(int?), Object defaultValue = default(Object), bool allowValuesNotSpecifiedInChoices = default(bool), Object stopWords = default(Object), Object metadata = default(Object), bool trainingFinished = default(bool), bool dirty = default(bool), int order = default(int), int trainedAfterDocumentsNumber = default(int), bool hiddenAlways = default(bool), string hideUntilPython = default(string), string hideUntilJs = default(string), DetectLimitUnitEnum? detectLimitUnit = default(DetectLimitUnitEnum?), int detectLimitCount = default(int), bool displayYesNo = default(bool), int? createdBy = default(int?), int? modifiedBy = default(int?), string vectorizerStopWords = default(string), string unsureChoiceValue = default(string), Object unsureThresholdsByValue = default(Object), string mlflowModelUri = default(string), bool mlflowDetectOnDocumentLevel = default(bool))
        {
            // to ensure "documentType" is required (not null)
            if (documentType == null)
            {
                throw new InvalidDataException("documentType is a required property for DocumentFieldDetail and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for DocumentFieldDetail and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for DocumentFieldDetail and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (modifiedBy == null)
            {
                throw new InvalidDataException("modifiedBy is a required property for DocumentFieldDetail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocumentFieldDetail);
        }

        /// <summary>
        /// Returns true if DocumentFieldDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentFieldDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentFieldDetail input)
        {
            if (input == null)
                return false;
