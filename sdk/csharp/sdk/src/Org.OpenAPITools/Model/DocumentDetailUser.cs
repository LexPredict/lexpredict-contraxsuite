...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentDetailUser :  IEquatable<DocumentDetailUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentDetailUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentDetailUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentDetailUser" /> class.
        /// </summary>
        ...
        public DocumentDetailUser(string firstName = default(string), string lastName = default(string), string username = default(string), int? role = default(int?), string name = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for DocumentDetailUser and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocumentDetailUser);
        }

        /// <summary>
        /// Returns true if DocumentDetailUser instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentDetailUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentDetailUser input)
        {
            if (input == null)
                return false;
