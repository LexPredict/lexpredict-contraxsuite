...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VerifyAuthTokenResponse :  IEquatable<VerifyAuthTokenResponse>, IValidatableObject
    {
        ...
        public VerifyAuthTokenResponse(string key = default(string), string userName = default(string), string releaseVersion = default(string), ProjectDetailOwnersDataInner user = default(ProjectDetailOwnersDataInner))
        {
        ...
        public ProjectDetailOwnersDataInner User { get; set; }
