...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrademarkUsage :  IEquatable<TrademarkUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrademarkUsage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrademarkUsage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrademarkUsage" /> class.
        /// </summary>
        /// <param name="trademark">trademark (required).</param>
        /// <param name="count">count.</param>
        public TrademarkUsage(string trademark = default(string), int count = default(int))
        {
            // to ensure "trademark" is required (not null)
            if (trademark == null)
            {
                throw new InvalidDataException("trademark is a required property for TrademarkUsage and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="trademark", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as TrademarkUsage);
        }

        /// <summary>
        /// Returns true if TrademarkUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of TrademarkUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrademarkUsage input)
        {
            if (input == null)
                return false;
        ...
        {
            // Trademark (string) maxLength
            if(this.Trademark != null && this.Trademark.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Trademark, length must be less than 200.", new [] { "Trademark" });
            }
