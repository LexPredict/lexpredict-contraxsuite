...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentDetailAssigneeData :  IEquatable<DocumentDetailAssigneeData>, IValidatableObject
    {
        ...
        public DocumentDetailAssigneeData(string firstName = default(string), string lastName = default(string), string username = default(string), int? role = default(int?), string name = default(string))
        {
