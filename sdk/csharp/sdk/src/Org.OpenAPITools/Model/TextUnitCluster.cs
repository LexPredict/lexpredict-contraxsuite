...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TextUnitCluster :  IEquatable<TextUnitCluster>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextUnitCluster" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextUnitCluster() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextUnitCluster" /> class.
        /// </summary>
        ...
        public TextUnitCluster(int clusterId = default(int), string name = default(string), string selfName = default(string), string description = default(string), string clusterBy = default(string), string _using = default(string), DateTime createdDate = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TextUnitCluster and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (selfName == null)
            {
                throw new InvalidDataException("selfName is a required property for TextUnitCluster and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for TextUnitCluster and cannot be null");
            }
            else
            {
            ...
            if (clusterBy == null)
            {
                throw new InvalidDataException("clusterBy is a required property for TextUnitCluster and cannot be null");
            }
            else
            {
            ...
            if (_using == null)
            {
                throw new InvalidDataException("_using is a required property for TextUnitCluster and cannot be null");
            }
            else
            {
                this.Using = _using;
        ...
        /// <summary>
        /// Gets or Sets TextUnitCount
        /// </summary>
        [DataMember(Name="text_unit_count", EmitDefaultValue=false)]
        public int TextUnitCount { get; private set; }

        /// <summary>
        /// Gets or Sets TextUnitData
        /// </summary>
        [DataMember(Name="text_unit_data", EmitDefaultValue=false)]
        public List<Object> TextUnitData { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TextUnitCount: ").Append(TextUnitCount).Append("\n");
            sb.Append("  TextUnitData: ").Append(TextUnitData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TextUnitCluster);
        }

        /// <summary>
        /// Returns true if TextUnitCluster instances are equal
        /// </summary>
        /// <param name="input">Instance of TextUnitCluster to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextUnitCluster input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TextUnitCount == input.TextUnitCount ||
                    (this.TextUnitCount != null &&
                    this.TextUnitCount.Equals(input.TextUnitCount))
                ) && 
                (
                    this.TextUnitData == input.TextUnitData ||
                    this.TextUnitData != null &&
                    input.TextUnitData != null &&
                    this.TextUnitData.SequenceEqual(input.TextUnitData)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TextUnitCount != null)
                    hashCode = hashCode * 59 + this.TextUnitCount.GetHashCode();
                if (this.TextUnitData != null)
                    hashCode = hashCode * 59 + this.TextUnitData.GetHashCode();
                return hashCode;
            }
        }
