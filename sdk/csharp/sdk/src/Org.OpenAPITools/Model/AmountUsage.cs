...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AmountUsage :  IEquatable<AmountUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmountUsage" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        /// <param name="amountStr">amountStr.</param>
        /// <param name="count">count.</param>
        public AmountUsage(decimal? amount = default(decimal?), string amountStr = default(string), int count = default(int))
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as AmountUsage);
        }

        /// <summary>
        /// Returns true if AmountUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of AmountUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmountUsage input)
        {
            if (input == null)
                return false;
