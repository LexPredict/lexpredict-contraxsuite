...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectClusteringDocumentClustersInner :  IEquatable<ProjectClusteringDocumentClustersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectClusteringDocumentClustersInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectClusteringDocumentClustersInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectClusteringDocumentClustersInner" /> class.
        /// </summary>
        /// <param name="clusterId">clusterId.</param>
        /// <param name="name">name (required).</param>
        public ProjectClusteringDocumentClustersInner(int clusterId = default(int), string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProjectClusteringDocumentClustersInner and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as ProjectClusteringDocumentClustersInner);
        }

        /// <summary>
        /// Returns true if ProjectClusteringDocumentClustersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectClusteringDocumentClustersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectClusteringDocumentClustersInner input)
        {
            if (input == null)
                return false;
