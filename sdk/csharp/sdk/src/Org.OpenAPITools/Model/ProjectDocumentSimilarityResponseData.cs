...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectDocumentSimilarityResponseData :  IEquatable<ProjectDocumentSimilarityResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDocumentSimilarityResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectDocumentSimilarityResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDocumentSimilarityResponseData" /> class.
        /// </summary>
        ...
        public ProjectDocumentSimilarityResponseData(string documentAName = default(string), string documentBName = default(string), string documentBText = default(string), decimal similarity = default(decimal))
        {
            // to ensure "documentAName" is required (not null)
            if (documentAName == null)
            {
                throw new InvalidDataException("documentAName is a required property for ProjectDocumentSimilarityResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentBName is a required property for ProjectDocumentSimilarityResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentBText is a required property for ProjectDocumentSimilarityResponseData and cannot be null");
            }
            else
            {
            ...
            if (similarity == null)
            {
                throw new InvalidDataException("similarity is a required property for ProjectDocumentSimilarityResponseData and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ProjectDocumentSimilarityResponseData);
        }

        /// <summary>
        /// Returns true if ProjectDocumentSimilarityResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectDocumentSimilarityResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectDocumentSimilarityResponseData input)
        {
            if (input == null)
                return false;
