...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentFieldCreate :  IEquatable<DocumentFieldCreate>, IValidatableObject
    {
        ...
        public enum ValueDetectionStrategyEnum
        {
            ...
            /// <summary>
            /// Enum Regexpsandtextbasedml for value: regexps_and_text_based_ml
            /// </summary>
            [EnumMember(Value = "regexps_and_text_based_ml")]
            Regexpsandtextbasedml = 5,
            ...
            /// <summary>
            /// Enum Formulaandfieldsbasedml for value: formula_and_fields_based_ml
            /// </summary>
            [EnumMember(Value = "formula_and_fields_based_ml")]
            Formulaandfieldsbasedml = 7,
            ...
            Fieldsbasedprobmlonly = 9,

            /// <summary>
            /// Enum Pythoncodedfield for value: python_coded_field
            /// </summary>
            [EnumMember(Value = "python_coded_field")]
            Pythoncodedfield = 10,
        ...
        /// <summary>
        /// Defines PythonCodedField
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PythonCodedFieldEnum
        {
            /// <summary>
            /// Enum GenericEarliestDate for value: generic.EarliestDate
            /// </summary>
            [EnumMember(Value = "generic.EarliestDate")]
            GenericEarliestDate = 1,

            /// <summary>
            /// Enum GenericLatestDate for value: generic.LatestDate
            /// </summary>
            [EnumMember(Value = "generic.LatestDate")]
            GenericLatestDate = 2,

            /// <summary>
            /// Enum GenericMaxCurrency for value: generic.MaxCurrency
            /// </summary>
            [EnumMember(Value = "generic.MaxCurrency")]
            GenericMaxCurrency = 3,

            /// <summary>
            /// Enum GenericParties for value: generic.Parties
            /// </summary>
            [EnumMember(Value = "generic.Parties")]
            GenericParties = 4,

            /// <summary>
            /// Enum SimilaritySimilarDocuments for value: similarity.SimilarDocuments
            /// </summary>
            [EnumMember(Value = "similarity.SimilarDocuments")]
            SimilaritySimilarDocuments = 5
        ...
        /// </summary>
        [DataMember(Name="python_coded_field", EmitDefaultValue=true)]
        public PythonCodedFieldEnum? PythonCodedField { get; set; }
        /// <summary>
        /// Defines Confidence
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Choose to add an upward limit to the amount of document text                                           ContraxSuite will search for this Document Field. For example, you can choose                                           to only search the first 10 paragraphs of text for the value required (this                                           often works best for values like “Company,” “Execution Date,” or “Parties,”                                          all of which typically appear in the first few paragraphs of a contract).</value>
        [DataMember(Name="detect_limit_unit", EmitDefaultValue=true)]
        ...
        /// <param name="valueRegexp">This regular expression is run on the sentence      found by a Field Detector and extracts a specific string value from a Text Unit. The first matching group is used if      the regular expression returns multiple matching groups. This is only applicable to string fields..</param>
        /// <param name="dependsOnFields">dependsOnFields.</param>
        /// <param name="confidence">confidence.</param>
        /// <param name="requiresTextAnnotations">requiresTextAnnotations.</param>
        /// <param name="readOnly">readOnly.</param>
        /// <param name="category">category.</param>
        /// <param name="family">family.</param>
        /// <param name="defaultValue">When populated, this      default value is displayed in the user interface’s annotator sidebar for the associated field. If not populated, the      Field Value remains empty by default. Please wrap entries with quotes, example: “landlord”. This is only applicable       to Choice and Multichoice fields..</param>
        /// <param name="choices">Newline-separated choices. A choice cannot contain a comma..</param>
        ...
        /// <param name="detectLimitUnit">Choose to add an upward limit to the amount of document text                                           ContraxSuite will search for this Document Field. For example, you can choose                                           to only search the first 10 paragraphs of text for the value required (this                                           often works best for values like “Company,” “Execution Date,” or “Parties,”                                          all of which typically appear in the first few paragraphs of a contract). (required).</param>
        /// <param name="detectLimitCount">Specify the maximum  range for a bounded search. Field detection begins at the top of the document and continues until this Nth  \&quot;Detect limit unit\&quot; element. (required).</param>
        ...
        public DocumentFieldCreate(string documentType = default(string), string code = default(string), string title = default(string), string description = default(string), TypeEnum type = default(TypeEnum), TextUnitTypeEnum? textUnitType = default(TextUnitTypeEnum?), ValueDetectionStrategyEnum? valueDetectionStrategy = default(ValueDetectionStrategyEnum?), PythonCodedFieldEnum? pythonCodedField = default(PythonCodedFieldEnum?), string classifierInitScript = default(string), string formula = default(string), bool convertDecimalsToFloatsInFormulaArgs = default(bool), string valueRegexp = default(string), List<string> dependsOnFields = default(List<string>), ConfidenceEnum? confidence = default(ConfidenceEnum?), bool requiresTextAnnotations = default(bool), bool readOnly = default(bool), int? category = default(int?), int? family = default(int?), Object defaultValue = default(Object), string choices = default(string), bool allowValuesNotSpecifiedInChoices = default(bool), Object stopWords = default(Object), Object metadata = default(Object), bool trainingFinished = default(bool), bool dirty = default(bool), int order = default(int), int trainedAfterDocumentsNumber = default(int), bool hiddenAlways = default(bool), string hideUntilPython = default(string), bool displayYesNo = default(bool), DetectLimitUnitEnum detectLimitUnit = default(DetectLimitUnitEnum), int detectLimitCount = default(int), string vectorizerStopWords = default(string), string unsureChoiceValue = default(string), Object unsureThresholdsByValue = default(Object), string mlflowModelUri = default(string), bool mlflowDetectOnDocumentLevel = default(bool))
        {
            // to ensure "documentType" is required (not null)
            if (documentType == null)
            {
                throw new InvalidDataException("documentType is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            // to ensure "detectLimitUnit" is required (not null)
            if (detectLimitUnit == null)
            {
                throw new InvalidDataException("detectLimitUnit is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
            ...
            // to ensure "detectLimitCount" is required (not null)
            if (detectLimitCount == null)
            {
                throw new InvalidDataException("detectLimitCount is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Classifier initialization script. Here is how it used: &lt;br /&gt;&lt;br /&gt;def&amp;nbsp;init_classifier_impl(field_code:&amp;nbsp;str,&amp;nbsp;init_script:&amp;nbsp;str):&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;if&amp;nbsp;init_script&amp;nbsp;is&amp;nbsp;not&amp;nbsp;None:&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;init_script&amp;nbsp;&#x3D;&amp;nbsp;init_script.strip()&lt;br /&gt;&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;if&amp;nbsp;not&amp;nbsp;init_script:&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;tree&amp;nbsp;as&amp;nbsp;sklearn_tree&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;return&amp;nbsp;sklearn_tree.DecisionTreeClassifier()&lt;br /&gt;&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;tree&amp;nbsp;as&amp;nbsp;sklearn_tree&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;neural_network&amp;nbsp;as&amp;nbsp;sklearn_neural_network&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;neighbors&amp;nbsp;as&amp;nbsp;sklearn_neighbors&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;svm&amp;nbsp;as&amp;nbsp;sklearn_svm&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;gaussian_process&amp;nbsp;as&amp;nbsp;sklearn_gaussian_process&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn.gaussian_process&amp;nbsp;import&amp;nbsp;kernels&amp;nbsp;as&amp;nbsp;sklearn_gaussian_process_kernels&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;ensemble&amp;nbsp;as&amp;nbsp;sklearn_ensemble&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;naive_bayes&amp;nbsp;as&amp;nbsp;sklearn_naive_bayes&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;discriminant_analysis&amp;nbsp;as&amp;nbsp;sklearn_discriminant_analysis&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;from&amp;nbsp;sklearn&amp;nbsp;import&amp;nbsp;linear_model&amp;nbsp;as&amp;nbsp;sklearn_linear_model&lt;br /&gt;&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;eval_locals&amp;nbsp;&#x3D;&amp;nbsp;{&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_linear_model&#39;:&amp;nbsp;sklearn_linear_model,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_tree&#39;:&amp;nbsp;sklearn_tree,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_neural_network&#39;:&amp;nbsp;sklearn_neural_network,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_neighbors&#39;:&amp;nbsp;sklearn_neighbors,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_svm&#39;:&amp;nbsp;sklearn_svm,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_gaussian_process&#39;:&amp;nbsp;sklearn_gaussian_process,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_gaussian_process_kernels&#39;:&amp;nbsp;sklearn_gaussian_process_kernels,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_ensemble&#39;:&amp;nbsp;sklearn_ensemble,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_naive_bayes&#39;:&amp;nbsp;sklearn_naive_bayes,&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&#39;sklearn_discriminant_analysis&#39;:&amp;nbsp;sklearn_discriminant_analysis&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;}&lt;br /&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;return&amp;nbsp;eval_script(&#39;classifier&amp;nbsp;init&amp;nbsp;script&amp;nbsp;of&amp;nbsp;field&amp;nbsp;{0}&#39;.format(field_code),&amp;nbsp;init_script,&amp;nbsp;eval_locals)&lt;br /&gt;</value>
        ...
        /// </summary>
        /// <value>This regular expression is run on the sentence      found by a Field Detector and extracts a specific string value from a Text Unit. The first matching group is used if      the regular expression returns multiple matching groups. This is only applicable to string fields.</value>
        ...
        public List<string> DependsOnFields { get; set; }
        ...
        /// </summary>
        /// <value>When populated, this      default value is displayed in the user interface’s annotator sidebar for the associated field. If not populated, the      Field Value remains empty by default. Please wrap entries with quotes, example: “landlord”. This is only applicable       to Choice and Multichoice fields.</value>
        ...
        /// </summary>
        /// <value>Newline-separated choices. A choice cannot contain a comma.</value>
        ...
        /// </summary>
        [DataMember(Name="stop_words", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>                     Enter a boolean expression in Python syntax. If this Python expression evaluates to True, then this              Document Field will be displayed in the user interface. Likewise, if this Python expression evaluates to              False, then this Document Field will be hidden from view. Importantly, if a document’s status is set to              complete and this Document Field remains hidden, then this Document Field’s data will be erased. Similarly,              this Document Field might contain data that a user can not review if it is hidden and the document has not              been set to complete.</value>
        ...
        /// </summary>
        /// <value>Target expression (\&quot;Hide until python\&quot; expression converted to JavaScript syntax for frontend). Allowed operators: +, -, *, /, &#x3D;&#x3D;&#x3D;, !&#x3D;&#x3D;, &#x3D;&#x3D;, !&#x3D;, &amp;&amp;, ||, &gt;, &lt;, &gt;&#x3D;, &lt;&#x3D;, %</value>
        [DataMember(Name="hide_until_js", EmitDefaultValue=true)]
        public string HideUntilJs { get; private set; }
        ...
        [DataMember(Name="detect_limit_count", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PythonCodedField: ").Append(PythonCodedField).Append("\n");
        ...
        public bool Equals(DocumentFieldCreate input)
        {
            ...
            return 
                ...
                (
                    this.PythonCodedField == input.PythonCodedField ||
                    (this.PythonCodedField != null &&
                    this.PythonCodedField.Equals(input.PythonCodedField))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PythonCodedField != null)
                    hashCode = hashCode * 59 + this.PythonCodedField.GetHashCode();
