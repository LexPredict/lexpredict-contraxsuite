...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DateDurationUsage :  IEquatable<DateDurationUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateDurationUsage" /> class.
        /// </summary>
        ...
        public DateDurationUsage(decimal? amount = default(decimal?), string amountStr = default(string), string durationType = default(string), decimal? durationDays = default(decimal?), int count = default(int))
        {
            this.Amount = amount;
        ...
        /// </summary>
        [DataMember(Name="duration_type", EmitDefaultValue=true)]
        public string DurationType { get; set; }

        /// <summary>
        /// Gets or Sets DurationDays
        /// </summary>
        [DataMember(Name="duration_days", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as DateDurationUsage);
        }

        /// <summary>
        /// Returns true if DateDurationUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of DateDurationUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateDurationUsage input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DurationType (string) maxLength
            if(this.DurationType != null && this.DurationType.Length > 1024)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DurationType, length must be less than 1024.", new [] { "DurationType" });
            }
