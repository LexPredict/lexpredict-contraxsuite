...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(string username = default(string), string lastName = default(string), string firstName = default(string), string email = default(string), bool isSuperuser = default(bool), bool isStaff = default(bool), bool isActive = default(bool), string name = default(string), int? role = default(int?), ProjectDetailRoleData roleData = default(ProjectDetailRoleData), string organization = default(string), List<int> groups = default(List<int>))
        {
