...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectStats :  IEquatable<ProjectStats>, IValidatableObject
    {
        ...
        /// <param name="documentStatusLoaded">documentStatusLoaded (required).</param>
        /// <param name="documentStatusLoadedPcnt">documentStatusLoadedPcnt (required).</param>
        ...
        public ProjectStats(int projectId = default(int), string name = default(string), string typeTitle = default(string), int documentsTotal = default(int), int clausesTotal = default(int), int? avgOcrGrade = default(int?), int documentStatusLoaded = default(int), decimal documentStatusLoadedPcnt = default(decimal), int documentStatusNotStarted = default(int), decimal documentStatusNotStartedPcnt = default(decimal), int documentStatusInReview = default(int), decimal documentStatusInReviewPcnt = default(decimal), int documentStatusAwaitingQa = default(int), decimal documentStatusAwaitingQaPcnt = default(decimal), int documentStatusCompleted = default(int), decimal documentStatusCompletedPcnt = default(decimal), int documentStatusExcluded = default(int), decimal documentStatusExcludedPcnt = default(decimal), int clauseStatusUnreviewed = default(int), decimal clauseStatusUnreviewedPcnt = default(decimal), int clauseStatusAccepted = default(int), decimal clauseStatusAcceptedPcnt = default(decimal), int clauseStatusRejected = default(int), decimal clauseStatusRejectedPcnt = default(decimal))
        {
            ...
            this.AvgOcrGrade = avgOcrGrade;
            // to ensure "documentStatusLoaded" is required (not null)
            if (documentStatusLoaded == null)
            {
                throw new InvalidDataException("documentStatusLoaded is a required property for ProjectStats and cannot be null");
            }
            else
            {
            ...
            // to ensure "documentStatusLoadedPcnt" is required (not null)
            if (documentStatusLoadedPcnt == null)
            {
                throw new InvalidDataException("documentStatusLoadedPcnt is a required property for ProjectStats and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets DocumentStatusLoaded
        /// </summary>
        [DataMember(Name="document_status_loaded", EmitDefaultValue=true)]
        public int DocumentStatusLoaded { get; set; }

        /// <summary>
        /// Gets or Sets DocumentStatusLoadedPcnt
        /// </summary>
        [DataMember(Name="document_status_loaded_pcnt", EmitDefaultValue=true)]
        public decimal DocumentStatusLoadedPcnt { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DocumentStatusLoaded: ").Append(DocumentStatusLoaded).Append("\n");
            sb.Append("  DocumentStatusLoadedPcnt: ").Append(DocumentStatusLoadedPcnt).Append("\n");
        ...
        public bool Equals(ProjectStats input)
        {
            ...
            return 
                ...
                (
                    this.DocumentStatusLoaded == input.DocumentStatusLoaded ||
                    (this.DocumentStatusLoaded != null &&
                    this.DocumentStatusLoaded.Equals(input.DocumentStatusLoaded))
                ) && 
                (
                    this.DocumentStatusLoadedPcnt == input.DocumentStatusLoadedPcnt ||
                    (this.DocumentStatusLoadedPcnt != null &&
                    this.DocumentStatusLoadedPcnt.Equals(input.DocumentStatusLoadedPcnt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DocumentStatusLoaded != null)
                    hashCode = hashCode * 59 + this.DocumentStatusLoaded.GetHashCode();
                if (this.DocumentStatusLoadedPcnt != null)
                    hashCode = hashCode * 59 + this.DocumentStatusLoadedPcnt.GetHashCode();
