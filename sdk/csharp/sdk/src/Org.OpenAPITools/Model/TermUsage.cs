...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermUsage :  IEquatable<TermUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermUsage" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        public TermUsage(int count = default(int))
        {
            this.Count = count;
        }

        /// <summary>
        /// Gets or Sets TermTerm
        /// </summary>
        [DataMember(Name="term__term", EmitDefaultValue=false)]
        public string TermTerm { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TermTerm: ").Append(TermTerm).Append("\n");
        ...
        {
            return this.Equals(input as TermUsage);
        }

        /// <summary>
        /// Returns true if TermUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of TermUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermUsage input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TermTerm == input.TermTerm ||
                    (this.TermTerm != null &&
                    this.TermTerm.Equals(input.TermTerm))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TermTerm != null)
                    hashCode = hashCode * 59 + this.TermTerm.GetHashCode();
                if (this.Count != null)
