...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectDetailOwnersDataInner :  IEquatable<ProjectDetailOwnersDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDetailOwnersDataInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectDetailOwnersDataInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDetailOwnersDataInner" /> class.
        /// </summary>
        ...
        public ProjectDetailOwnersDataInner(string username = default(string), string lastName = default(string), string firstName = default(string), string email = default(string), bool isSuperuser = default(bool), bool isStaff = default(bool), bool isActive = default(bool), string name = default(string), string initials = default(string), string organization = default(string), List<int> groups = default(List<int>))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for ProjectDetailOwnersDataInner and cannot be null");
            }
            else
            {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for ProjectDetailOwnersDataInner and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        {
            return this.Equals(input as ProjectDetailOwnersDataInner);
        }

        /// <summary>
        /// Returns true if ProjectDetailOwnersDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectDetailOwnersDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectDetailOwnersDataInner input)
        {
            if (input == null)
                return false;
