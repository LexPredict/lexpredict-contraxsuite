...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectDetailOwnersData :  IEquatable<ProjectDetailOwnersData>, IValidatableObject
    {
        ...
        public ProjectDetailOwnersData(string username = default(string), string lastName = default(string), string firstName = default(string), string email = default(string), bool isSuperuser = default(bool), bool isStaff = default(bool), bool isActive = default(bool), string name = default(string), int? role = default(int?), ProjectDetailRoleData roleData = default(ProjectDetailRoleData), string organization = default(string), List<int> groups = default(List<int>))
        {
        ...
        public ProjectDetailRoleData RoleData { get; set; }
