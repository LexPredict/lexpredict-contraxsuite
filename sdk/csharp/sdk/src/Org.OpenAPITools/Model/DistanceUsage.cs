...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistanceUsage :  IEquatable<DistanceUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistanceUsage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DistanceUsage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DistanceUsage" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        /// <param name="distanceType">distanceType (required).</param>
        /// <param name="count">count.</param>
        public DistanceUsage(decimal? amount = default(decimal?), string distanceType = default(string), int count = default(int))
        {
            this.Amount = amount;
            // to ensure "distanceType" is required (not null)
            if (distanceType == null)
            {
                throw new InvalidDataException("distanceType is a required property for DistanceUsage and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DistanceUsage);
        }

        /// <summary>
        /// Returns true if DistanceUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of DistanceUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistanceUsage input)
        {
            if (input == null)
                return false;
        ...
        {
            // DistanceType (string) maxLength
            if(this.DistanceType != null && this.DistanceType.Length > 1024)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DistanceType, length must be less than 1024.", new [] { "DistanceType" });
            }
