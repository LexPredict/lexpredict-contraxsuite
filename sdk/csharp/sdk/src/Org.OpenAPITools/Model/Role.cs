...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Role :  IEquatable<Role>, IValidatableObject
    {
        ...
        public Role(string name = default(string), string code = default(string), int order = default(int), bool isAdmin = default(bool), bool isTopManager = default(bool), bool isManager = default(bool))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for Role and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for Role and cannot be null");
            }
            else
            {
                this.Order = order;
