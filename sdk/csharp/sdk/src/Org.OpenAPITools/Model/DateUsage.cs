...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DateUsage :  IEquatable<DateUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateUsage" /> class.
        /// </summary>
        ...
        public DateUsage(DateTime date = default(DateTime), int count = default(int))
        {
            // to ensure "date" is required (not null)
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for DateUsage and cannot be null");
            }
            else
            {
                this.Date = date;
        ...
        {
            return this.Equals(input as DateUsage);
        }

        /// <summary>
        /// Returns true if DateUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of DateUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateUsage input)
        {
            if (input == null)
                return false;
