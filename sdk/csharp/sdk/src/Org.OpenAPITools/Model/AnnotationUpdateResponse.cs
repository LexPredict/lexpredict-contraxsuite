...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnotationUpdateResponse :  IEquatable<AnnotationUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnotationUpdateResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnnotationUpdateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnotationUpdateResponse" /> class.
        /// </summary>
        ...
        public AnnotationUpdateResponse(int document = default(int), string documentName = default(string), string field = default(string), string fieldName = default(string), Object value = default(Object), string project = default(string), int? locationStart = default(int?), int? locationEnd = default(int?), string locationText = default(string), int? modifiedBy = default(int?))
        {
            // to ensure "document" is required (not null)
            if (document == null)
            {
                throw new InvalidDataException("document is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentName is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
            ...
            if (field == null)
            {
                throw new InvalidDataException("field is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
                this.Field = field;
            ...
            if (fieldName == null)
            {
                throw new InvalidDataException("fieldName is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (project == null)
            {
                throw new InvalidDataException("project is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("locationStart is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
            ...
            if (locationEnd == null)
            {
                throw new InvalidDataException("locationEnd is a required property for AnnotationUpdateResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AnnotationUpdateResponse);
        }

        /// <summary>
        /// Returns true if AnnotationUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnotationUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnotationUpdateResponse input)
        {
            if (input == null)
                return false;
