...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectDocumentSimilarityResponse :  IEquatable<ProjectDocumentSimilarityResponse>, IValidatableObject
    {
        ...
        public ProjectDocumentSimilarityResponse(List<ProjectDocumentSimilarityResponseData> data = default(List<ProjectDocumentSimilarityResponseData>), int? documentAId = default(int?), string documentAName = default(string), int totalRecords = default(int))
        {
        ...
        public List<ProjectDocumentSimilarityResponseData> Data { get; set; }
