...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldCategoryListFieldsInner :  IEquatable<DocumentFieldCategoryListFieldsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldCategoryListFieldsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentFieldCategoryListFieldsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldCategoryListFieldsInner" /> class.
        /// </summary>
        ...
        public DocumentFieldCategoryListFieldsInner(string id = default(string), int? category = default(int?), string code = default(string), string title = default(string), int order = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DocumentFieldCategoryListFieldsInner and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for DocumentFieldCategoryListFieldsInner and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for DocumentFieldCategoryListFieldsInner and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        {
            return this.Equals(input as DocumentFieldCategoryListFieldsInner);
        }

        /// <summary>
        /// Returns true if DocumentFieldCategoryListFieldsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentFieldCategoryListFieldsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentFieldCategoryListFieldsInner input)
        {
            if (input == null)
                return false;
