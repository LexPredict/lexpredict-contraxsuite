...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentFieldDetectorDetail :  IEquatable<DocumentFieldDetectorDetail>, IValidatableObject
    {
        ...
        public DocumentFieldDetectorDetail(CategoryEnum? category = default(CategoryEnum?), string field = default(string), string excludeRegexps = default(string), string definitionWords = default(string), bool regexpsPreProcessLower = default(bool), string detectedValue = default(string), ExtractionHintEnum? extractionHint = default(ExtractionHintEnum?), TextPartEnum? textPart = default(TextPartEnum?))
        {
        ...
        public string IncludeRegexps { get; private set; }
