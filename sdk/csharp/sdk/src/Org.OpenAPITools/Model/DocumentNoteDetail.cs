...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentNoteDetail :  IEquatable<DocumentNoteDetail>, IValidatableObject
    {
        ...
        public DocumentNoteDetail(string note = default(string), DateTime timestamp = default(DateTime), DocumentNoteDetailUser user = default(DocumentNoteDetailUser), int? locationStart = default(int?), int? locationEnd = default(int?), int documentId = default(int), int fieldValueId = default(int), string fieldId = default(string))
        {
