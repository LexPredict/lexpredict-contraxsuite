...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectDocumentSimilarityResponseDataInner :  IEquatable<ProjectDocumentSimilarityResponseDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDocumentSimilarityResponseDataInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectDocumentSimilarityResponseDataInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDocumentSimilarityResponseDataInner" /> class.
        /// </summary>
        ...
        public ProjectDocumentSimilarityResponseDataInner(string documentAName = default(string), string documentBName = default(string), string documentBText = default(string), decimal similarity = default(decimal))
        {
            // to ensure "documentAName" is required (not null)
            if (documentAName == null)
            {
                throw new InvalidDataException("documentAName is a required property for ProjectDocumentSimilarityResponseDataInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentBName is a required property for ProjectDocumentSimilarityResponseDataInner and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentBText is a required property for ProjectDocumentSimilarityResponseDataInner and cannot be null");
            }
            else
            {
            ...
            if (similarity == null)
            {
                throw new InvalidDataException("similarity is a required property for ProjectDocumentSimilarityResponseDataInner and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ProjectDocumentSimilarityResponseDataInner);
        }

        /// <summary>
        /// Returns true if ProjectDocumentSimilarityResponseDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectDocumentSimilarityResponseDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectDocumentSimilarityResponseDataInner input)
        {
            if (input == null)
                return false;
