...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CopyrightUsage :  IEquatable<CopyrightUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CopyrightUsage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CopyrightUsage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CopyrightUsage" /> class.
        /// </summary>
        /// <param name="copyrightStr">copyrightStr (required).</param>
        /// <param name="count">count.</param>
        public CopyrightUsage(string copyrightStr = default(string), int count = default(int))
        {
            // to ensure "copyrightStr" is required (not null)
            if (copyrightStr == null)
            {
                throw new InvalidDataException("copyrightStr is a required property for CopyrightUsage and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets CopyrightStr
        /// </summary>
        [DataMember(Name="copyright_str", EmitDefaultValue=true)]
        public string CopyrightStr { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CopyrightStr: ").Append(CopyrightStr).Append("\n");
        ...
        {
            return this.Equals(input as CopyrightUsage);
        }

        /// <summary>
        /// Returns true if CopyrightUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of CopyrightUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CopyrightUsage input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CopyrightStr == input.CopyrightStr ||
                    (this.CopyrightStr != null &&
                    this.CopyrightStr.Equals(input.CopyrightStr))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CopyrightStr != null)
                    hashCode = hashCode * 59 + this.CopyrightStr.GetHashCode();
                if (this.Count != null)
        ...
        {
            // CopyrightStr (string) maxLength
            if(this.CopyrightStr != null && this.CopyrightStr.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CopyrightStr, length must be less than 200.", new [] { "CopyrightStr" });
            }
