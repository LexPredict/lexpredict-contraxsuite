...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectDocumentsSimilarityByVectorsForm :  IEquatable<ProjectDocumentsSimilarityByVectorsForm>, IValidatableObject
    {
        ...
        protected ProjectDocumentsSimilarityByVectorsForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDocumentsSimilarityByVectorsForm" /> class.
        /// </summary>
        ...
        public ProjectDocumentsSimilarityByVectorsForm(string runName = default(string), int? similarityThreshold = 75, int project = default(int), string featureSource = "vector", DistanceTypeEnum? distanceType = DistanceTypeEnum.Cosine, int itemId = default(int), bool createReverseRelations = default(bool), bool useTfidf = default(bool), bool delete = default(bool))
        {
            ...
            if (runName == null)
            {
                throw new InvalidDataException("runName is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
            ...
            if (project == null)
            {
                throw new InvalidDataException("project is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
            ...
            if (itemId == null)
            {
                throw new InvalidDataException("itemId is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
                this.ItemId = itemId;
            ...
            {
                throw new InvalidDataException("createReverseRelations is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
            ...
            if (useTfidf == null)
            {
                throw new InvalidDataException("useTfidf is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
            ...
            if (delete == null)
            {
                throw new InvalidDataException("delete is a required property for ProjectDocumentsSimilarityByVectorsForm and cannot be null");
            }
            else
            {
                this.Delete = delete;
