...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentDetailAvailableAssigneesDataInner :  IEquatable<DocumentDetailAvailableAssigneesDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentDetailAvailableAssigneesDataInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentDetailAvailableAssigneesDataInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentDetailAvailableAssigneesDataInner" /> class.
        /// </summary>
        ...
        public DocumentDetailAvailableAssigneesDataInner(string firstName = default(string), string lastName = default(string), string username = default(string), string name = default(string), string initials = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for DocumentDetailAvailableAssigneesDataInner and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocumentDetailAvailableAssigneesDataInner);
        }

        /// <summary>
        /// Returns true if DocumentDetailAvailableAssigneesDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentDetailAvailableAssigneesDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentDetailAvailableAssigneesDataInner input)
        {
            if (input == null)
                return false;
