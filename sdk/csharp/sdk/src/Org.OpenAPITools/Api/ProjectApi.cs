...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IProjectApi : IApiAccessor
    {
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">A unique integer value identifying this project.</param>
        /// <param name="makeSearchablePDFRequest"> (optional)</param>
        /// <returns>TaskIdResponse</returns>
        TaskIdResponse ProjectProjectsIdMakeSearchablePdfPOST (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest));
        ...
        /// <param name="makeSearchablePDFRequest"> (optional)</param>
        /// <returns>ApiResponse of TaskIdResponse</returns>
        ApiResponse<TaskIdResponse> ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfo (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uploadSession"> (optional)</param>
        /// <returns>UploadSession</returns>
        UploadSession ProjectUploadSessionPOST (UploadSession uploadSession = default(UploadSession));
        ...
        ApiResponse<UploadSession> ProjectUploadSessionPOSTWithHttpInfo (UploadSession uploadSession = default(UploadSession));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TaskIdResponse</returns>
        System.Threading.Tasks.Task<TaskIdResponse> ProjectProjectsIdMakeSearchablePdfPOSTAsync (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TaskIdResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<TaskIdResponse>> ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfoAsync (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UploadSession> ProjectUploadSessionPOSTAsync (UploadSession uploadSession = default(UploadSession), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UploadSession>> ProjectUploadSessionPOSTWithHttpInfoAsync (UploadSession uploadSession = default(UploadSession), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ProjectApi : IProjectApi
    {
        ...
        /// <param name="makeSearchablePDFRequest"> (optional)</param>
        /// <returns>TaskIdResponse</returns>
        public TaskIdResponse ProjectProjectsIdMakeSearchablePdfPOST (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest))
        {
             ApiResponse<TaskIdResponse> localVarResponse = ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfo(id, makeSearchablePDFRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="makeSearchablePDFRequest"> (optional)</param>
        /// <returns>ApiResponse of TaskIdResponse</returns>
        public ApiResponse<TaskIdResponse> ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfo (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProjectApi->ProjectProjectsIdMakeSearchablePdfPOST");

            var localVarPath = "/api/v1/project/projects/{id}/make-searchable-pdf/";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (id != null) localVarPathParams.Add("id", this.Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (makeSearchablePDFRequest != null && makeSearchablePDFRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(makeSearchablePDFRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = makeSearchablePDFRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ProjectProjectsIdMakeSearchablePdfPOST", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TaskIdResponse</returns>
        public async System.Threading.Tasks.Task<TaskIdResponse> ProjectProjectsIdMakeSearchablePdfPOSTAsync (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TaskIdResponse> localVarResponse = await ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfoAsync(id, makeSearchablePDFRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TaskIdResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TaskIdResponse>> ProjectProjectsIdMakeSearchablePdfPOSTWithHttpInfoAsync (string id, MakeSearchablePDFRequest makeSearchablePDFRequest = default(MakeSearchablePDFRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProjectApi->ProjectProjectsIdMakeSearchablePdfPOST");
        ...
        /// <param name="uploadSession"> (optional)</param>
        /// <returns>UploadSession</returns>
        public UploadSession ProjectUploadSessionPOST (UploadSession uploadSession = default(UploadSession))
        {
             ApiResponse<UploadSession> localVarResponse = ProjectUploadSessionPOSTWithHttpInfo(uploadSession);
             return localVarResponse.Data;
        }
        ...
        /// <param name="uploadSession"> (optional)</param>
        /// <returns>ApiResponse of UploadSession</returns>
        public ApiResponse<UploadSession> ProjectUploadSessionPOSTWithHttpInfo (UploadSession uploadSession = default(UploadSession))
        {
            ...
            if (uploadSession != null && uploadSession.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(uploadSession); // http body (model) parameter
            }
            else
            {
                localVarPostBody = uploadSession; // byte array
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UploadSession</returns>
        public async System.Threading.Tasks.Task<UploadSession> ProjectUploadSessionPOSTAsync (UploadSession uploadSession = default(UploadSession), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UploadSession> localVarResponse = await ProjectUploadSessionPOSTWithHttpInfoAsync(uploadSession, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UploadSession)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UploadSession>> ProjectUploadSessionPOSTWithHttpInfoAsync (UploadSession uploadSession = default(UploadSession), CancellationToken cancellationToken = default(CancellationToken))
        {
